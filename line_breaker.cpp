...
void special_keys(int key, int x, int y) {
  ...
  if (key == GLUT_KEY_RIGHT) {
    move_right = true;
    PlaySound("sb.wav", NULL, SND_ASYNC|SND_FILENAME);
    //_rocket.trans_x += 0.003f;
    //cout << _rocket.trans_x << endl;
  }
